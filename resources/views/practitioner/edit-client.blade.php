        ...
        <div class="container-fluid py-4">
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form name="edit-client-form" id="edit-client-form" method="post" action="{{route('store-edit-client-practitioner', ['id'=> $user->id]) }}" enctype="multipart/form-data" class="w-full">
                                @csrf
                                @method('PUT')
