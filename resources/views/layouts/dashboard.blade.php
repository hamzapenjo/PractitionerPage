...
<body class="g-sidenav-show  bg-gray-200">
      ...
      <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
          @if(auth()->check())
            @if(auth()->user()->type === 1)
            <li class="nav-item" >
                <a class="nav-link text-white  {{ $activePage == 'dash' ? 'bg-gradient-primary' : '' }}" href="{{ route('practitioner-dashboard') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">dashboard</i>
                    </div>
                    <span class="nav-link-text ms-1">{{ __('Practitioner Dashboard') }}</span>
                </a>
            </li>
            <li class="nav-item" >
                <a class="nav-link text-white {{ $activePage == 'clients' ? 'bg-gradient-primary' : '' }}" href="{{ route('practitioner-clients') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="material-icons opacity-10">group</i>
                    </div>
                    <span class="nav-link-text ms-1">{{ __('Clients') }}</span>
                </a>
            </li>
            <li class="nav-item" >
                <a class="nav-link text-white {{ $activePage == 'practice' ? 'bg-gradient-primary' : '' }}" href="{{ route('practice') }}">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <div class="text-grey text-center me-2 d-flex align-items-center justify-content-center">
            <button type="button" class="btn bg-gradient-danger toast-btn mt-3" data-bs-toggle="modal" data-bs-target="#logoutModal">
                Log out
            </button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <form method="POST" action="{{ route('logout') }}">
                                ...
                                <button type="submit" class="btn btn-danger mb-1">Log out</button>
                            </form>
                        </div>
                    </div>
                </div>
  ...
  <!--   Core JS Files   -->
  @vite([
        'resources/js/core/popper2.min.js',
        'resources/js/core/bootstrap2.min.js',
        'resources/js/plugins/perfect-scrollbar2.min.js',
